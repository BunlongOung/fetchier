...
module.exports = {
  GQL, GET, DELETE: GET, POST, PUT, wsGQL, wsGQLSubscribe, wsGQLUnsubscribe, wsGQLclose, WS
}
...
async function PUT({ url, method = 'PUT', body = {}, nocors, contentTypeForm, token, headers = {}, debug }){
